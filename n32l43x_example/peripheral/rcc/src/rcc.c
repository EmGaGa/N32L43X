...
static void DumpClock(const char * msg);
...
static void DumpClock(const char * msg)
{
    ...
    Usart_Init(); // should reinit after sysclk changed
    PRO_LOG(LOG_DEBUG, "--------------------------------\n");
    PRO_LOG(LOG_DEBUG, "%s:\n", msg);
    RCC_GetClocksFreqValue(&RCC_ClockFreq);
    PRO_LOG(LOG_DEBUG, "SYSCLK: %d\n", RCC_ClockFreq.SysclkFreq);
    PRO_LOG(LOG_DEBUG, "HCLK: %d\n", RCC_ClockFreq.HclkFreq);
    PRO_LOG(LOG_DEBUG, "PCLK1: %d\n", RCC_ClockFreq.Pclk1Freq);
    PRO_LOG(LOG_DEBUG, "PCLK2: %d\n", RCC_ClockFreq.Pclk2Freq);
}
